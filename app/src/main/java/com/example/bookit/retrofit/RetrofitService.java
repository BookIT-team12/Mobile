...
//    }
    ...
    // sad odo da spavam da i ja legnem na vreme.
    // Ovo bi van autorizacije trebalo da radi(falice token?),
    // napravljen je api folder koji predstavlja ono sto je servis u angularu bio.
    // Ostavio sam da bude api jer ko zna mozda nam zatreba
    // da nesto bude servis odavde pa reko neka ostane,
    // a ovo neka bude api.
    // Dodao sam i User i UserCredentials(ovo vraca register
    // na backu pa sam samo zato pravio iskreno nemam blage zasto sam napravio da se vraca UserCredentials
    // a ne User na backu al ajde)
    // necu sad ispravljati to sigurno.
    // Taj User i UserCredentials predstavljaju zapravo backend dto objekte.
