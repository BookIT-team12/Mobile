...
public class UserTokenService {
    ...
    public User getCurrentUser(UserTokenState jwtToken) throws ParseException {     //could cause errors, caase it could return currentUser before userApi.getUser() sets it.
        JWT jwt = JWTParser.parse(jwtToken.getAccessToken());
